...
class CableTransaction extends StatefulWidget {
  const CableTransaction({super.key});

  @override
  State<CableTransaction> createState() => _CableTransactionState();
}

class _CableTransactionState extends State<CableTransaction> {
  @override
  Widget build(BuildContext context) {
    CableSuccessModel? transactions = Get.arguments;
