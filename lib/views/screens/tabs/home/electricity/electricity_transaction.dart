...
class ElectricityTransaction extends StatefulWidget {
  const ElectricityTransaction({super.key});

  @override
  State<ElectricityTransaction> createState() => _ElectricityTransactionState();
}

class _ElectricityTransactionState extends State<ElectricityTransaction> {
  @override
  Widget build(BuildContext context) {
    AirtimeSuccessModel? transactions = Get.arguments;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          trailing: Text(
                            "${transactions?.previousBalance}".toCurrency(),
                            style: theme.textTheme.bodyLarge!,
                          ),
                        ),
                        ListTile(
