...
class ConfirmelEctricityScreen extends StatefulWidget {
  const ConfirmelEctricityScreen({super.key});

  @override
  State<ConfirmelEctricityScreen> createState() =>
      _ConfirmelEctricityScreenState();
}

class _ConfirmelEctricityScreenState extends State<ConfirmelEctricityScreen> {
  bool? isLoading = false;
  final _electricityController = Get.find<ElectrictyController>();
  final authController = Get.find<AuthController>();
  @override
  void initState() {
    checkBiometric();
    amount = Get.parameters["amount"];
    meterNumber = Get.parameters["meter"];
    provider = Get.parameters["provider"];
    meter = Get.arguments;
    super.initState();
  }
  ...
  Future<void> confirmElectric() async {
    try {
      setState(() {
        isLoading = true;
      });
      await _electricityController.payBill(
        providerId: provider,
