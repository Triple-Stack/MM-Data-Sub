...
class ExamTransaction extends StatefulWidget {
  const ExamTransaction({super.key});

  @override
  State<ExamTransaction> createState() => _ExamTransactionState();
}

class _ExamTransactionState extends State<ExamTransaction> {
  @override
  Widget build(BuildContext context) {
    ExamSuccessModel? transactions = Get.arguments;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          trailing: Text(
                            "${transactions.amountPaid!}".toCurrency(),
                            style: theme.textTheme.bodyLarge!,
                          ),
                        ),
                        ListTile(
