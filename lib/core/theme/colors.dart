...
// #1B7EC7
  static const Color primary = Color(0xFF1B7EC7);
  static const Color onPrimary = Color(0xFFFFFFFF);
  static const Color secondary = Color(0xFFF9550C);
  ...
  static const Color darkPrimary = Color(0xFF1B7EC7);
  static const Color darkOnPrimary = Color(0xFFFFFFFF);
  static const Color darkSecondary = Color(0xFFF9550C);
